...
const Head = () => {
  return (
    <>
      ...
      <meta name="author" content="Farouq Ayofe" />
      <meta
        name="keywords"
        content="farouq.dev, ayofef, farouq ayofe, front-end developer, freelance, web developer, portfolio, Frontend Engineer, Frontend Developer, Dublin, Ireland, Frontend"
      />
      <meta
        name="description"
